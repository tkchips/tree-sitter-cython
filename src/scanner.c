...
bool tree_sitter_cython_external_scanner_scan(void *payload, TSLexer *lexer, const bool *valid_symbols) {
...
unsigned tree_sitter_cython_external_scanner_serialize(void *payload, char *buffer) {
    Scanner *scanner = (Scanner *)payload;
...
void tree_sitter_cython_external_scanner_deserialize(void *payload, const char *buffer, unsigned length) {
    Scanner *scanner = (Scanner *)payload;
